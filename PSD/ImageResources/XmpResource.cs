...
//        {
//            get { return XmpMetaFactory.SerializeToString(XmpMeta, new SerializeOptions()); }
//            set { XmpMeta = XmpMetaFactory.ParseFromString(value, new ParseOptions()); }
//        }

//        public XmpResource(string name)
//            : base(name)
//        {
//        }

//        public XmpResource(PsdBinaryReader br, string name, int numBytes)
//            : base(name)
//        {
//            try
//            {
...
//        public override ResourceID ID { get { return ResourceID.XmpMetadata; } }
