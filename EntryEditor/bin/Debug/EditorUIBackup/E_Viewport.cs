    ...
    public partial class EditorUI
    {
        ...
        class View : Widget
        {
            ...
            public override bool Save()
            {
                ...
                // save uiscene.cs
                GeneratorUICode generator = new GeneratorUICode();
        ...
        private void ViewportDrawLines(UIElement sender, GRAPHICS spriteBatch, Entry e)
        {
            ...
            if (!drawBorder)
            {
                ...
                ForParentPriority(EditingScene, null,
                    element =>
                    {
						...
						spriteBatch.Draw(patchViewportElementBorder, element.ViewClip, null, C.ColorBorder);
                    });
            }
            ...
            if (Editing)
            {
                ...
                {
					spriteBatch.Draw(patchViewportSelectedParentBorder, currentParent.ViewClip, null, C.ColorFocusBorder);
                }
            }
            ...
            if (Selected != null)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    pivot.Y = i != 0 ? C.ScaleAnchorRadius : 0;
                    ...
                    for (int j = 0; j < 3; j++)
                    {
                        ...
                        pivot.X = j != 0 ? C.ScaleAnchorRadius : 0;

                        if (p == mode)
                            spriteBatch.Draw(Scaler, scalerPosition, scalerSource, C.ColorFocusBorder, pivot, VECTOR2.One);
                        else
                            spriteBatch.Draw(Scaler, scalerPosition, scalerSource, C.ColorBorder, pivot, VECTOR2.One);
                    }
                }
            }
