...
..\..\EntryBuilder.exe BuildConstantTable ..\Tables_Build\_C.xlsx ..\..\Launch\Server\Tables\C.xml ..\..\Code\Protocol\_C.design.cs true 12.0
...
..\..\EntryBuilder.exe BuildConstantTable ..\Tables_Build\_CS.xlsx ..\..\Launch\Server\Tables\CS.xml ..\..\Code\Server\_CS.design.cs true 12.0
