...
public partial class S新建服务类型
{
    ...
    {
        L启动命令.UIText.Text = _LANGUAGE.GetString("1");
        L启动命令.Text = _LANGUAGE.GetString("1");
        L启动文件.UIText.Text = _LANGUAGE.GetString("2");
        L启动文件.Text = _LANGUAGE.GetString("2");
        LSVN密码.UIText.Text = _LANGUAGE.GetString("3");
        LSVN密码.Text = _LANGUAGE.GetString("3");
        LSVN账号.UIText.Text = _LANGUAGE.GetString("4");
        LSVN账号.Text = _LANGUAGE.GetString("4");
        LSVN目录.UIText.Text = _LANGUAGE.GetString("5");
        LSVN目录.Text = _LANGUAGE.GetString("5");
