...
public partial class S账号管理菜单
{
    ...
    {
        L平台.UIText.Text = _LANGUAGE.GetString("46");
        L平台.Text = _LANGUAGE.GetString("46");
        ...
        B同平台.UIText.Text = _LANGUAGE.GetString("47");
        B同平台.Text = _LANGUAGE.GetString("47");
        B同名.UIText.Text = _LANGUAGE.GetString("48");
        B同名.Text = _LANGUAGE.GetString("48");
        ...
        B删除.UIText.Text = _LANGUAGE.GetString("38");
        B删除.Text = _LANGUAGE.GetString("38");
