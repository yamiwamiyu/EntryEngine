...
public partial class S登陆菜单
{
    ...
    private void Initialize()
    {
        ...
        TB服务端.CursorAreaColor = new COLOR()
        {
            B = 51,
            G = 153,
            R = 255,
        ...
        TB服务端.DefaultText.FontSize = 16f;
