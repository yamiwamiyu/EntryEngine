...
public partial class S新开服菜单
{
    ...
    {
        ICoroutine ___async;
        Entry.ShowDialogScene(S160613103204[0]);
        Entry.ShowDialogScene(S160613103204[1]);
    ...
    public void Show(UIScene __scene)
    {
        ...
        L执行命令.UIText.Text = _LANGUAGE.GetString("12");
        L执行命令.Text = _LANGUAGE.GetString("12");
        ...
        L服务器.UIText.Text = _LANGUAGE.GetString("13");
        L服务器.Text = _LANGUAGE.GetString("13");
        L类型.UIText.Text = _LANGUAGE.GetString("14");
        L类型.Text = _LANGUAGE.GetString("14");
