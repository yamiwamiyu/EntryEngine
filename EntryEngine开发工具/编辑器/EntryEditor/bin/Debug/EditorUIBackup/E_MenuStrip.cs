...
namespace EditorUI
{
    public partial class EditorUI
    {
        ...
        {
			TEXTURE icon = new PATCH(TEXTURE.Pixel, RECT.Empty, new COLOR(180, 220, 220, 255), null);
		...
		private void ResavePreviewCode(UIElement sender, Entry e)
		{
			...
			if (Directory.Exists(dir))
			{
				...
				foreach (var item in scenes)
				{
                    ...
                    byte[] content = SaveUI(widget, true);
        ...
        private void AllVisible(UIElement sender, Entry e)
        {
            ...
            EditingScene.ForeachParentPriority(null, ui => ui.Visible = true);
        }
    }
}
