...
public partial class EditorParticle
{
    ...
    private void Initialize()
    {
        ...
        TBDirectory.UIText.TextShader = new EntryEngine.UI.TextShader();
    ...
    protected override IEnumerable<ICoroutine> Loading()
    {
        ...
        P161129151337.Background = PATCH.GetNinePatch(null, new COLOR(0, 0, 0, 255), 2);
        ...
        PViewPreview.Background = PATCH.GetNinePatch(null, new COLOR(0, 0, 0, 255), 2);
        PViewProperty.Background = PATCH.GetNinePatch(null, new COLOR(0, 0, 0, 255), 2);
        PPFTool.Background = PATCH.GetNinePatch(null, new COLOR(0, 0, 0, 255), 2);
        ...
        PViewPF.Background = PATCH.GetNinePatch(null, new COLOR(0, 0, 0, 255), 2);
    ...
    private void Show(UIScene __scene, UIScene __previous)
    {
