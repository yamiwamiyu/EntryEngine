...
namespace DragonBone
{
    ...
    public class DRAGONBONES : TEXTURE, IArmatureProxy
    {
        ...
        {
            var armature = PipelineDragonBones.factory.BuildArmature(this.DragonBonesData, this.Texture);
    ...
    public class PipelineDragonBones : ContentPipeline
    {
        ...
        protected override Content Load(string file)
        {
            ...
            var armature = factory.BuildArmature(dragonbonesData, textureData);
            return (DRAGONBONES)armature.proxy;
        }
