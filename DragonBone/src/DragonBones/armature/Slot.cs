...
namespace EntryEngine.DragonBone.DBCore
{
    ...
    public abstract class Slot : TransformObject
    {
        ...
        protected void _UpdateDisplayData()
        {
            ...
            if (this._displayData != prevDisplayData || currentVerticesData != prevVerticesData || this._textureData != prevTextureData)
            {
                ...
                if (currentVerticesData != prevVerticesData)
                {
                    if (this._deformVertices == null)
                    {
                        this._deformVertices = new DeformVertices();
                    }
        ...
        /// <internal/>
        /// <private/>
        internal bool _SetDisplayIndex(int value, bool isAnimation)
        {
            if (isAnimation)
            {
        ...
        /// <private/>
        internal void ReplaceDisplayData(DisplayData value, int displayIndex)
        {
            if (displayIndex < 0)
            {
                if (this._displayIndex < 0)
        ...
        public int displayIndex
        {
            ...
            set
            {
                if (this._SetDisplayIndex(value, false))
                {
                    this.Update(-1);
                }
            }
